...
class DateTimePickerDialog(QDialog):
    def __init__(self, parent=None):
        ...
        self.calendar.setStyleSheet("""
            ...
            QCalendarWidget QToolButton { color: white; background-color: #2c3e50; padding: 5px; border-radius: 3px; }
            QCalendarWidget QMenu { background-color: #34495e; color: white; padding: 5px; }
            QCalendarWidget QSpinBox { background-color: #34495e; color: white; padding: 3px; border: 1px solid #2c3e50; }
...
class LocationSearchBar(QLineEdit):
    def __init__(self, parent=None):
        ...
        # Initialize location data and network manager
        self.location_data = None
        self.network_manager = QNetworkAccessManager()
        self.network_manager.finished.connect(self.handle_response)
        
        # Create enhanced completer with dropdown
        ...
        # Connect text changes to API search
    ...
    def search_location(self, text):
        if len(text) > 1:
            ...
            url.setQuery(f"q={text}, Trinidad and Tobago&format=json&limit=7&addressdetails=1")
